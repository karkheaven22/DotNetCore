...
{
    private FileLoggerSettings _configuration;
    private readonly ConcurrentDictionary<string, InitLoggerModel> _loggerKeys = new ConcurrentDictionary<string, InitLoggerModel>();
    ...
    private IEnumerable<string> GetKeys(string categoryName)
    {

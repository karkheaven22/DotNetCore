...
namespace DotNetCore.Models
{
    ...
    public class SeriesLineEntityConfiguration : IEntityTypeConfiguration<Model_SeriesLine>
    {
        public void Configure(EntityTypeBuilder<Model_SeriesLine> builder)
        {
